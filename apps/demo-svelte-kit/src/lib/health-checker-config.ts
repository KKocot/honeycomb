...
export const healthCheckerServices: HealthCheckerServiceConfig[] = [
  {
    key: "hive-node-api",
    ...
    createCheckers: (chain) => {
      ...
      return [
        ...
        },
        {
          ...
          validatorFunction: (data: any) =>
            data?.length > 0 ? true : "Bridge API list communities error",
        },
        {
          ...
          validatorFunction: (data: any) =>
            data?.length > 0 ? true : "Bridge API get ranked posts error",
        },
      ];
    },
  },
