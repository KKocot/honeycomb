    ...
    >
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <span class="text-sm text-muted-foreground font-medium">Vue + Nuxt</span>
          <a
            href="/docs"
            target="_blank"
...
const TABS: readonly TabConfig[] = [
  ...
  },
  {
    ...
    description:
      "Rich markdown editor with toolbar, split preview, dark mode and draft auto-save.",
  },
];
...
const active_tab = computed<TabId>(() => {
  const tab = route.query.tab;
  if (typeof tab === "string" && is_valid_tab(tab)) {
    return tab;
  }
  return "api-tracker";
});
