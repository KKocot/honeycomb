...
// Available options: "author" | "thumbnail" | "payout" | "votes" | "comments" | "reblog" | "time"`,
  withCallback: `// Optional callback after vote
<HivePostCard
  author="barddev"
  permlink="my-post"
  onVote={(weight) => console.log("Voted:", weight)}
  onReblog={() => console.log("Reblogged!")}
/>`,
    ...
    <article className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-lg text-muted-foreground">
          Display Hive posts with thumbnail, stats, and interactive actions.
        </p>
      </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Fetches post data automatically. Handles voting, reblogging, and NSFW detection.
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border">
              ...
              <tr>
                ...
                <td className="py-3 px-4 text-muted-foreground"><code>{`("author" | "thumbnail" | "payout" | "votes" | "comments" | "reblog" | "time")[]`}</code></td>
