<script lang="ts">
  ...
  import type { PostHideOption } from "@barddev/honeycomb-svelte";
...
<div class="space-y-6">
  <section class="border border-border rounded-lg p-6 bg-muted/20">
    ...
    <p class="text-sm text-muted-foreground mb-4">
      Default full card with thumbnail, author, title, body preview, and stats.
    </p>
  ...
  <section class="border border-border rounded-lg p-6 bg-muted/20">
    ...
    <p class="text-sm text-muted-foreground mb-4">
      Inline layout with small thumbnail, title, and stats. Good for lists and
      sidebars.
    </p>
  ...
  <section class="border border-border rounded-lg p-6 bg-muted/20">
    ...
    <p class="text-sm text-muted-foreground mb-4">
      ...
      prop to selectively remove payout, votes, comments, author, thumbnail, or time.
    </p>
    <div class="max-w-lg">
      <HivePostCard
        author={POST_A.author}
